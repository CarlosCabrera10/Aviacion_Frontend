...
@Component({
  ...
  template: `
    <div class="container">
      ...
      <form #form="ngForm" (ngSubmit)="guardar(form)" novalidate>
        ...
        <div class="row">
          <label>Nombre:</label>
          <input class="input" name="nombre" [(ngModel)]="usuario.nombre"
        ...
        <div class="row">
          ...
          <input class="input" name="apellido" [(ngModel)]="usuario.apellido"
        ...
        <div class="row">
          <label>Correo:</label>
          <input class="input" type="email" name="correo" [(ngModel)]="usuario.correo"
        ...
        <div class="row">
          ...
          <input class="input" name="telefono" [(ngModel)]="usuario.telefono"
        ...
        <div class="row">
          <label>Rol:</label>
          <select class="input" name="rol" [(ngModel)]="usuario.rol"
        ...
        <div class="row">
          <label>Estado:</label>
          <select class="input" name="activo" [(ngModel)]="usuario.activo" required #activo="ngModel">
            <option [ngValue]="true">Activo</option>

            <!-- 🔒 NO PERMITIR "Inactivo" SI ES ADMINISTRADOR -->
        ...
        <div class="row" *ngIf="!editMode">
          ...
          <input type="password" class="input" name="contrasena"
            [(ngModel)]="usuario.contrasena" required minlength="6" #contrasena="ngModel" />
  ...
  styles: [`
    ...
    label { font-weight: bold; margin-bottom: 0.3rem; color: #444; }
    .input { padding: 0.6rem; border-radius: 6px; border: 1px solid #ccc; font-size: 14px; }
    .hint { font-size: 12px; color: #777; margin-top: 0.2rem; }
    ...
    .error { color: #d9534f; font-size: 13px; margin-top: 0.3rem; }
    .success { color: #28a745; font-weight: bold; margin-top: 0.5rem; }
  `]
})
  ...
  ngOnInit(): void {
    ...
    if (id) {
      ...
      this.usuariosService.obtenerPorId(+id).subscribe({
        ...
        error: () => { this.mensajeError = 'Error al cargar los datos del usuario.'; }
      });
    }
  }
